...
import fun.Fear.events.player.EntitySpawnEvent;
import fun.Fear.events.player.PostMotionEvent;
...
import fun.Fear.utils.features.aura.rotations.impl.SnapAngle;
